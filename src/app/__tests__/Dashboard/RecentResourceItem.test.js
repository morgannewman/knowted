...
describe('<RecentResourceItem />', () => {
	let wrapper;
	beforeEach(() => {
		wrapper = shallow(<RecentResourceItem topics={topicsData} resources={resourcesData} />);
	});
  ...
  it('renders ul section', ()=>{
    let wrapper;
    wrapper = mount(<RecentResourceItem topics={topicsData} resources={resourcesData} />);
